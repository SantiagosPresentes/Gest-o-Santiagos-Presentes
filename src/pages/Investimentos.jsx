  ...
  return (
    <div>
      ...
      <div style={card}>
        ...
        <button onClick={salvarInvestimento} style={{background:'#e94560', color:'white', border:'none', padding:'12px 24px', borderRadius:'8px', cursor:'pointer', fontSize:'16px', width:'100%'}}>
